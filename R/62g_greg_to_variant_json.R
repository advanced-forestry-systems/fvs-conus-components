...
block <- list(
  ...
  crown = list(source = "fvs_conus_cr_recession",
               note = "Greg repo has no fitted crown-change equation; CR recession uses the fvs-conus kernel (disclosed)"),
  ...
  components_present = c("diameter_growth", "height_growth", "survival")
)
